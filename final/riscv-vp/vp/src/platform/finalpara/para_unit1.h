...
struct para_unit1 : public sc_module {
  ...
  SC_HAS_PROCESS(para_unit1);

  para_unit1(sc_module_name n): 
    sc_module(n), 
    tsock("t_skt"), 
    base_offset(0) 
  {
    tsock.register_b_transport(this, &para_unit1::blocking_transport);
