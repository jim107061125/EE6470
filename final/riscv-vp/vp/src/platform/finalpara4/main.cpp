...
#include "terminal.h"
//#include "LU.h"
#include "para_unit1.h"
#include "para_unit2.h"
#include "filter_def.h"
#include "para_unit3.h"
#include "para_unit4.h"
...
public:
	...
	addr_t para1_START_addr = 0x73000000;
 	addr_t para1_size = 0x01000000;
 	addr_t para1_end_addr = para1_START_addr + para1_size - 1;
	addr_t para2_START_addr = 0x74000000;
 	addr_t para2_size = 0x01000000;
 	addr_t para2_end_addr = para2_START_addr + para2_size - 1;
	addr_t para3_START_addr = 0x75000000;
 	addr_t para3_size = 0x01000000;
 	addr_t para3_end_addr = para3_START_addr + para3_size - 1;
	addr_t para4_START_addr = 0x76000000;
 	addr_t para4_size = 0x01000000;
 	addr_t para4_end_addr = para4_START_addr + para4_size - 1;
	...
	void parse(int argc, char **argv) override {
		...
		assert((mem_end_addr < clint_start_addr || mem_start_addr > para1_end_addr) &&
		       "RAM too big, would overlap memory");
		assert((mem_end_addr < clint_start_addr || mem_start_addr > para2_end_addr) &&
		       "RAM too big, would overlap memory");
...
int sc_main(int argc, char **argv) {
	...
	//LU L_U("L_U");
	para_unit1 para1("para1");
	para_unit2 para2("para2");
	para_unit3 para3("para3");
	para_unit4 para4("para4");
	...
	core0.init(instr_mem_if0, data_mem_if0, &clint, entry_point,
	...
	bus.ports[12] = new PortMapping(opt.para1_START_addr, opt.para1_end_addr);
	bus.ports[13] = new PortMapping(opt.para2_START_addr, opt.para2_end_addr);
	bus.ports[14] = new PortMapping(opt.para3_START_addr, opt.para3_end_addr);
	bus.ports[15] = new PortMapping(opt.para4_START_addr, opt.para4_end_addr);
	//bus.ports[13] = new PortMapping(opt.para1_START_addr, opt.para1_end_addr);
	...
	bus.isocks[12].bind(para1.tsock);
	bus.isocks[13].bind(para2.tsock);
	bus.isocks[14].bind(para3.tsock);
	bus.isocks[15].bind(para4.tsock);
