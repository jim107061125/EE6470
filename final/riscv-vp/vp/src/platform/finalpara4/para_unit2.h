...
struct para_unit2 : public sc_module {
  tlm_utils::simple_target_socket<para_unit2> tsock;
  ...
  SC_HAS_PROCESS(para_unit2);

  para_unit2(sc_module_name n): 
    sc_module(n), 
    tsock("t_skt"), 
    base_offset(0) 
  {
    tsock.register_b_transport(this, &para_unit2::blocking_transport);
