...
const int CORE0_W1_ADDR = 0x00000000;
const int CORE0_W2_ADDR = 0x00000004;
const int CORE0_R_ADDR = 0x00000010;
const int CORE1_W1_ADDR = 0x00000000;
const int CORE1_W2_ADDR = 0x00000004;
const int CORE1_R_ADDR = 0x00000010;
const int PARA3_W1_ADDR = 0x00000000;
const int PARA3_W2_ADDR = 0x00000004;
const int PARA3_R_ADDR = 0x00000010;
const int PARA4_W1_ADDR = 0x00000000;
const int PARA4_W2_ADDR = 0x00000004;
const int PARA4_R_ADDR = 0x00000010;
