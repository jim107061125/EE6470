...
define_hls_module LU ../LU.cpp

### 4. Define your HLS configuration (arbitrary names, BASIC and DPA in this example). 
define_hls_config LU BASIC
define_hls_config LU DPA       --dpopt_auto=op,expr
...
define_sim_config V_BASIC "LU RTL_V BASIC"
### 5.3 The Verilog simulation for HLS config "DPA". 
define_sim_config V_DPA "LU RTL_V DPA"
