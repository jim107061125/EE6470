...
public:
	...
	sc_out < bool >  o_rst;
#ifndef NATIVE_SYSTEMC
	cynw_p2p< sc_dt::sc_int<5> >::base_out o_n;
  cynw_p2p< sc_dt::sc_int<24> >::base_out o_a;
  cynw_p2p< sc_dt::sc_int<24> >::base_out o_b;
	cynw_p2p< sc_dt::sc_int<24> >::base_in i_x;
#else
	sc_fifo_out< sc_dt::sc_int<5> > o_n;
  sc_fifo_out< sc_dt::sc_int<24> > o_a;
  sc_fifo_out< sc_dt::sc_int<24> > o_b;
	sc_fifo_in< sc_dt::sc_int<24> > i_x;
#endif
